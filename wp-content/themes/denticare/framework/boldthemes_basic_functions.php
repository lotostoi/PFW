 ...
 if ( ! function_exists( 'boldthemes_get_image_html' ) ) {
	function boldthemes_get_image_html( $arg ) {
		...
		if ( shortcode_exists( 'bt_bb_image' ) ) {
			$output = do_shortcode( '[bt_bb_image image="' . esc_attr( $image ) . '" size="' . esc_attr( $size ) . '" shape="' . esc_attr( $shape ) . '" align="' . esc_attr( $align ) . '" url="' . esc_attr( $url ) . '" target="' . esc_attr( $target ) . '" el_style="' . esc_attr( $el_style ) . '" el_class="' . esc_attr( $el_class ) . '" el_id="' . esc_attr( $el_id ) . '"]', false );
		} else {
