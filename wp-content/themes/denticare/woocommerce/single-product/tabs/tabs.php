			...
			<ul class="bt_bb_tabs_header" style="<?php echo esc_attr( $style_html ); ?>">
				<?php foreach ( $tabs as $key => $tab ) : ?>
					<li class="<?php echo esc_attr( $key ); ?>_tab">
						<span><?php echo apply_filters( 'woocommerce_product_' . wp_kses_post( $key ) . '_tab_title', esc_html( $tab['title'] ), $key ); ?></span>
					</li>
				<?php endforeach; ?>
			</ul>
	...
	<div class="btArticleShareEtc">
		<div class="btTagsColumn">
			<?php 
                            ...
                            echo '<div class="btTags"><ul>' . wp_kses_post( $tags_html ) . '</ul></div>'; 
