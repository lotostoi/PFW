...
<?php
	...
	/*if ( is_singular( 'post' ) ) {
		...
		$boldthemes_options['hide_headline'] = true;
	}*/
...
<body <?php body_class(); ?> style="background-image:url(<?php echo esc_url_raw( $page_background ); ?>)">
...
<div class="btPageWrap" id="top">
	...
	<div class="btContentWrap btClear">
		...
		/*if ( is_singular( 'post' ) ) {
			echo '<div class = "btSinglePostHeader"></div>';
		}*/
?>
