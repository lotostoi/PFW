...
class bt_bb_masonry_portfolio_tiles extends BT_BB_Element {
	...
	function handle_shortcode( $atts, $content ) {
		...
		if ( $category_filter == 'yes' ) {
			...
			$output .= '<div class="bt_bb_post_grid_filter">';
				$output .= '<span class="bt_bb_masonry_portfolio_tiles_filter_item bt_bb_post_grid_filter_item active" data-category-portfolio="" data-format-portfolio="' . esc_attr( $format ) . '" data-post-type="portfolio">' . esc_html__( 'All', 'denticare' ) . '</span>';
				foreach ( $cats as $cat ) {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Masonry Portfolio Tiles', 'denticare' ), 'description' => esc_html__( 'Masonry tiles with portfolio', 'denticare' ), 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
