...
class bt_bb_features_table extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Features Table', 'denticare' ), 'description' => esc_html__( 'Display product features in a tabelar manner.', 'denticare' ), 'icon' => 'bt_bb_icon_bt_bb_price_list',
			'params' => array(
				array( 'param_name' => 'title', 'type' => 'textarea', 'heading' => esc_html__( 'Table header', 'denticare' ), 'description' => esc_html__( 'value;value; - type as many, but pay attention that there\' the same number of them. Use <strong> to make header in accent color.', 'denticare' ) ),
				array( 'param_name' => 'table', 'type' => 'textarea', 'heading' => esc_html__( 'Table', 'denticare' ), 'description' => esc_html__( 'value;value; - type as many, but pay attention that there\' the same number of them. Use *yes* as ticked checkbox, *no* as crossed out item.', 'denticare' ) ),
