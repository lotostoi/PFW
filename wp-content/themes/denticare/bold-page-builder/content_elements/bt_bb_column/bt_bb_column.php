	...
	function map_shortcode() {
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Column', 'denticare' ), 'description' => esc_html__( 'Column element', 'denticare' ), 'width_param' => 'width', 'container' => 'vertical', 'accept' => array( 'bt_bb_section' => false, 'bt_bb_row' => false, 'bt_bb_column' => false, 'bt_bb_column_inner' => false, 'bt_bb_tab_item' => false, 'bt_bb_accordion_item' => false, 'bt_bb_cost_calculator_item' => false, 'bt_cc_group' => false, 'bt_cc_multiply' => false, 'bt_cc_item' => false, 'bt_bb_content_slider_item' => false, 'bt_bb_google_maps_location' => false, '_content' => false ), 'accept_all' => true, 'toggle' => false,
			'params' => array(
				...
				array( 'param_name' => 'opacity', 'type' => 'textfield', 'heading' => esc_html__( 'Background color opacity (e.g. 0.4)', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ) ),
				...
				array( 'param_name' => 'highlight', 'type' => 'dropdown', 'default' => 'no', 'heading' => esc_html__( 'Show shadow on column', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ),
					'value' => array(
							esc_html__( 'No', 'denticare' ) => 'no',
							esc_html__( 'Yes', 'denticare' ) => 'yes'
					)
				),
				array( 'param_name' => 'align_to_edge_column', 'type' => 'dropdown', 'default' => 'no', 'heading' => esc_html__( 'Align column to screen edges on mobile screens - below 992px', 'denticare' ), 'group' => esc_html__( 'Responsive', 'denticare' ),
					'value' => array(
						esc_html__( 'No', 'denticare' ) => 'no',
						esc_html__( 'Align to left screen edge', 'denticare' ) => 'left',
						esc_html__( 'Align to right screen edge', 'denticare' ) => 'right',
						esc_html__( 'Align to both screen edges', 'denticare' ) => 'both'
					)
				),				
			)
		) );
