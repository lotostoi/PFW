...
class bt_bb_progress_bar_advanced extends BT_BB_Element {
	...
	function map_shortcode() {
		...
		bt_bb_map( $this->shortcode, array( 'name' => esc_html__( 'Advanced Progress bar', 'denticare' ), 'description' => esc_html__( 'Advanced Progress bar', 'denticare' ), 'container' => 'vertical', 'accept' => false, 'icon' => $this->prefix_backend . 'icon' . '_' . $this->shortcode,
			'params' => array(
				array( 'param_name' => 'type', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress Bar Type', 'denticare' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Semi circle', 'denticare' ) => 'semi-circle',
						esc_html__( 'Circle', 'denticare' ) => 'circle'
					)
				),
				array( 'param_name' => 'percentage', 'type' => 'textfield', 'heading' => esc_html__( 'Percentage', 'denticare' ), 'preview' => true ),
				array( 'param_name' => 'duration', 'type' => 'textfield', 'heading' => esc_html__( 'Animation duration', 'denticare' ), 'preview' => true ),
						array( 'param_name' => 'easing', 'type' => 'dropdown', 'heading' => esc_html__( 'Easing', 'denticare' ), 'preview' => true,
					'value' => array(
						esc_html__( 'Linear', 'denticare' ) => 'linear',
						esc_html__( 'Ease In Out', 'denticare' ) => 'easeInOut',
						esc_html__( 'Bounce', 'denticare' ) => 'bounce'
					)
				),
				array( 'param_name' => 'text', 'type' => 'textfield', 'heading' => esc_html__( 'Text below the icon or percentage', 'denticare' ), 'preview' => true ),				
				array( 'param_name' => 'icon', 'type' => 'iconpicker', 'heading' => esc_html__( 'Icon', 'denticare' ), 'value' => $icon_arr, 'preview' => true ),
				array( 'param_name' => 'url', 'type' => 'textfield', 'heading' => esc_html__( 'URL', 'denticare' ) ),
				array( 'param_name' => 'target', 'type' => 'dropdown', 'heading' => esc_html__( 'URL Target', 'denticare' ),
					'value' => array(
				...
				array( 'param_name' => 'thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar thickness', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ),
					'value' => array(
						esc_html__( 'Small', 'denticare' ) => 'small',
						esc_html__( 'Normal', 'denticare' ) => 'normal',
						esc_html__( 'Medium', 'denticare' ) => 'medium',
				...
				array( 'param_name' => 'trail_thickness', 'type' => 'dropdown', 'heading' => esc_html__( 'Progress bar trail thickness', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ),
					'value' => array(
						esc_html__( 'Same as progress bar', 'denticare' ) => 'progressbar',
						esc_html__( 'Small', 'denticare' ) => 'small',
						esc_html__( 'Normal', 'denticare' ) => 'normal',
						esc_html__( 'Medium', 'denticare' ) => 'medium',
						esc_html__( 'Large', 'denticare' ) => 'large',
				...
				array( 'param_name' => 'color_from', 'type' => 'colorpicker', 'heading' => esc_html__( 'Starting Progress Bar Background color', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ) ),
				array( 'param_name' => 'color_to', 'type' => 'colorpicker', 'heading' => esc_html__( 'Ending Progress Bar Background color', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ) ),
				array( 'param_name' => 'text_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Text color', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ) ),
				array( 'param_name' => 'trail_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Color for lighter trail stroke underneath the actual progress path', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ) ),
				array( 'param_name' => 'fill_color', 'type' => 'colorpicker', 'heading' => esc_html__( 'Fill color', 'denticare' ), 'group' => esc_html__( 'Design', 'denticare' ) ),
				array( 'param_name' => 'transparent', 'type' => 'checkbox', 'value' => array( esc_html__( 'Yes', 'denticare' ) => 'show_transparent_trail' ), 'heading' => esc_html__( 'Show trail as semi transparent', 'denticare' ), 'description' => esc_html__( 'Makes the progress bar trail semi transparent, at opacity od 10%.', 'denticare' ), 'preview' => true, 'group' => esc_html__( 'Design', 'denticare' ) )
			)
		) );
	}
}
